<?php
/**
 * Block 5 - Slider Widget
 * www.wordpressleaf.com
 */

// Register the widget
add_action( 'widgets_init', create_function( '', 'return register_widget("Codilight_Lite_Widget_Block5");'));

// The widget class
class Codilight_Lite_Widget_Block5 extends WP_Widget {

	public function __construct() {
		$widget_ops = array('classname' => 'block5_widget', 'description' => esc_html__( "在首页底部区域显示三篇文章，宽屏显示，应该放在首页第五个位置。WordPressLeaf出品。www.wordpressleaf.com", 'codilight-lite') );
		parent::__construct('ft_block5', esc_html__('FT Block 5 - WordPressLeaf出品', 'codilight-lite'), $widget_ops);
				...
				echo '<div class="row">';
					...
					<article <?php post_class( 'col-md-4 col-sm-12' ); ?>>
					    <div class="entry-thumb">
							...
							<img  style="width:325px;height:170px"  src="<?php echo post_thumbnail_src()?>">
							</a>
							<?php
	...
	public function form( $instance ) {
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'number_posts' ); ?>"><?php esc_html_e('文章显示数量：', 'codilight-lite') ?></label>
