...
jQuery(document).ready(function() {
        ...
        var leaf_modal_body_p = jQuery('<p id="leaf_webchat"><img src="http://localhost/wpc/wp-content/themes/codilight-lite/assets/images/weixin.png" width="220" height="220" alt="二维码加载失败..." ></p>'); //创建一个p
        ...
        var leaf_modal_footer_div = jQuery('<div id="jiathis_weixin_tip" class="weixin_tip">打开微信，点击底部的“发现”，使用 “扫一扫” 即可关注。（这个二维码测试用）</div>'); //创建一个div
        ...
        jQuery('#menu-social-items a').on('click',function(e){
        	    ...
        	    // thisurl='http://wx.qq.com';
        	    //console.log('变量：',thisurl);
       ...
       /* 
         jQuery('#menu-social-items #menu-item-241 a').click(function (e) {
         e.preventDefault();
         //判断弹出窗口是否存在       
         if(jQuery('#leaf_weixin_share').is(":hidden") ){
