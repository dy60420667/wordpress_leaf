...
<footer class="footer">
	...
	<?php } ?>
    &copy; <?php echo date('Y'); ?> <a href="<?php bloginfo('url'); ?>"><?php bloginfo('name'); ?></a> &nbsp; <?php echo __('本站主题由', 'haoui') ?> <a href="http://py40.com" target="_blank">http://py40.com</a> <?php echo __('提供', 'haoui') ?> &nbsp;
