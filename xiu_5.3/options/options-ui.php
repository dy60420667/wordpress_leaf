...
function opshui_page() {
    ...
    <div id="opshui-metabox" class="metabox-holder">
		...
		<div class="opshui-sidebar"><div class="opshui-sidebar-widget"><a href="http://themebetter.com" target="_blank"><img src="http://themebetter.com/tm/z8Bjer/opad"></a></div></div>
	</div>
